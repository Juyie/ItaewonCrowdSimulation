    ...
    public class TargetController : MonoBehaviour
    {
        ...
        public void MoveTargetToRandomPosition()
        {
            ...
            do 
            {
                ...
                RaycastHit hit;
                if (UnityEngine.Physics.Raycast(newTargetPos, Vector3.down, out hit, Mathf.Infinity, layerMask))
                {
                    newTargetPos.y = hit.point.y + Random.Range(spawnY.x, spawnY.y);
                }

                hitColliders = UnityEngine.Physics.OverlapSphere(newTargetPos, transform.localScale.x / 2);
